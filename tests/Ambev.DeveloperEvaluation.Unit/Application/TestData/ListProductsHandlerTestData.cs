...
public static class ListProductsHandlerTestData
{
    ...
    /// </summary>
    private static readonly Faker<ListProductsQuery> listProductsHandlerFaker = new Faker<ListProductsQuery>()
        .RuleFor(u => u.Page, 1)
        .RuleFor(u => u.Size, 10)
    ...
    public static ListProductsQuery GenerateValidQuery()
    {
